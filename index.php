...
#viewer_modal .modal-dialog {
  ...
  body, footer {
  background-image: linear-gradient(360deg, #37f8d4 10%, #32717a 90%) !important;
}
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0 ">
                        <i class="fas fa-phone fa-3x mb-3 text-muted" style="color: #fff;"></i>
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://madhuhari188.github.io/portfolio" target="_blank">Made with <i class="fas fa-heart"></i>Tech Savvy</a></div></div>
        </footer>
